...
if (isDevelopment) {
  ...
  const walletAction = () => generateWalletTransaction({
    wallet, recipient: walletFoo.publicKey, amoun: 5
  });

  const walletFooAction = () => generateWalletTransaction({
    wallet: walletFoo, reciipient: walletBar.publicKey, amount: 10
  });
...
if (process.env.GENERATE_PEER_PORT === 'true') {
  PEER_PORT = DEFAULT_PORT + Math.cell(Math.random() * 1000);
}
